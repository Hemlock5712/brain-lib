...
import static org.team5712.lib.constants.DrivetrainConstants.*;
...
public class SwerveSpeedController {
    ...
    public SwerveSpeedController(int port, ModuleConfiguration moduleConfiguration, ShuffleboardContainer container) {
        sensorPositionCoefficient = Math.PI * moduleConfiguration.getWheelDiameter() * moduleConfiguration.getDriveReduction() / TICKS_PER_ROTATION;
    ...
    public void setReferenceVelocity(double velocity) {
        ...
        double arbFeedForward = feedforward.calculate(velocity) / nominalVoltage;
        motor.set(
