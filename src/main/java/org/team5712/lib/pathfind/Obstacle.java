...
import org.team5712.lib.util.Doubles;
...
public class Obstacle {
    ...
    private class ObstacleEdge {
        ...
        public ObstacleEdge(double xpoints, double ypoints, double xpoints2, double ypoints2) {
            point1 = new Translation2d(xpoints, ypoints);
            point2 = new Translation2d(xpoints2, ypoints2);
        }
